-- -----------------------------------------------------
-- Backup dari https://code.google.com/p/simuktiblogspot/source/browse/trunk/sql/simuktiblogspot_data_kabupaten_propinsi_indonesia.sql
...
CREATE  TABLE IF NOT EXISTS `propinsi` (
  `id_propinsi` INT(2) UNSIGNED NOT NULL ,
  `nama_propinsi` VARCHAR(128) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `kabupaten` (
  `id_kabupaten` INT(3) UNSIGNED NOT NULL ,
  `nama_kabupaten` VARCHAR(128) NOT NULL ,
  `id_propinsi` INT(2) UNSIGNED NOT NULL ,
  PRIMARY KEY (`id_kabupaten`, `id_propinsi`) ,
  CONSTRAINT `fk_kabupaten_propinsi`
    FOREIGN KEY (`id_propinsi` )
    REFERENCES `propinsi` (`id_propinsi` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB DEFAULT CHARSET=utf8;
...
-- -----------------------------------------------------
INSERT INTO `kabupaten` (`id_kabupaten`, `nama_kabupaten`, `id_propinsi`) VALUES
